  ...
  return (
    <div className="max-w-6xl mx-auto px-4 space-y-4 sm:space-y-6 md:space-y-8">
      <div className="space-y-6">
        ...
        <div>
          <h3 className="heading-section text-gray-900 mb-2">Gerenciar Usuários</h3>
      ...
      {showForm && (
        <div className="card-premium rounded-xl p-5 space-y-4">
          <h4 className="font-semibold text-gray-900">➕ Novo Usuário</h4>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="col-span-2">
                <label className="block text-xs uppercase tracking-widest text-gray-500 mb-2">Tipo de Usuário *</label>
                <select
                  value={formData.role}
      ...
      <div className="space-y-3">
        <h4 className="font-semibold text-gray-900">Usuários ({users.length})</h4>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-gray-700">
                  <th className="text-left py-3 px-4 text-xs text-gray-500 uppercase">Usuário</th>
                  <th className="text-left py-3 px-4 text-xs text-gray-500 uppercase">Login</th>
                  <th className="text-left py-3 px-4 text-xs text-gray-500 uppercase">Matrícula</th>
                  <th className="text-left py-3 px-4 text-xs text-gray-500 uppercase">Tipo</th>
                  <th className="text-left py-3 px-4 text-xs text-gray-500 uppercase">Desde</th>
              ...
              <tbody>
                {users.map(user => (
                  <tr key={user.id} className="border-b border-gray-800 hover:bg-gray-800/30 transition-colors">
                    ...
                    <td className="py-3 px-4 text-gray-500">{user.number || '-'}</td>
                    <td className="py-3 px-4">
                      <span
